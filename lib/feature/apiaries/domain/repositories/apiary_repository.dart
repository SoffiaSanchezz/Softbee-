...
abstract class ApiaryRepository {
  ...
  Future<Either<Failure, Apiary>> createApiary(String userId, String name, String? location, int beehivesCount, bool treatments);
  Future<Either<Failure, Apiary>> updateApiary(String apiaryId, String userId, String? name, String? location, int? beehivesCount, bool? treatments);
